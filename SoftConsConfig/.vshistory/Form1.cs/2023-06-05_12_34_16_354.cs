            ...
            if (!flag)
            {
                ...
                try
                {
                    ...
                    do
                    {
						...
						bool FF1 = text2.IndexOf("ModoFila=") != -1 && text.IndexOf("FILEBAT000") != -1;
						if (FF1)
						{
							text2 = "ModoFila=1";
							streamWriter.WriteLine(text2);
                            ...
                            bool FF2 = text2.IndexOf("ModoFila=") != -1 && text.IndexOf("FILEBAT001") != -1;
                            if (FF2)
                            {
                                text2 = "ModoFila=1";
                                streamWriter.WriteLine(text2);
                            ...
                            {
                                bool FF3 = text2.IndexOf("ModoFila=") != -1 && text.IndexOf("FILEBAT002") != -1;
                                if (FF3)
                                {
                                    text2 = "ModoFila=1";
                                    streamWriter.WriteLine(text2);
                                ...
                                {
                                    bool FF4= text2.IndexOf("ModoFila=") != -1 && text.IndexOf("FILEBAT001") != -1;
                                    if (FF4)
                                    {
                                        text2 = "ModoFila=1";
                                        streamWriter.WriteLine(text2);
